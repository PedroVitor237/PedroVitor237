...
`React` · `TypeScript` · `TanStack Start` · `TanStack Router` · `TanStack Query` · `Prisma` · `PostgreSQL` · `Tailwind CSS` · `PWA` · `IndexedDB`
...
The platform is focused on the management and monitoring of water and forest resources, with data processing and planned mapping capabilities for environmental and spatial data.
